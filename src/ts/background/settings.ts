...
export class Settings {
    ...
    public update = ({ settings }: { settings?: any } = {}): Promise<void> =>
        err_async(async () => {
            const settings_final: any = n(settings) ? settings : this.default_settings;
    ...
    public update_debounced = _.debounce(({ settings }: { settings: any }): void => {
